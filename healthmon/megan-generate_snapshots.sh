...
SNAPGRAPH=/u/vplaces/scripts/healthmon/jp-snapgraph.pl

# T C B
$SNAPGRAPH --minutes 1440 --output $IMGDIR/jp-tcb.24h.png --thumbnail T C B &
$SNAPGRAPH --minutes 180 --output $IMGDIR/jp-tcb.3h.png --thumbnail T C B &
$SNAPGRAPH --minutes 60 --output $IMGDIR/jp-tcb.1h.png --thumbnail T C B ;
