...
SNAPGRAPH=/u/vplaces/scripts/healthmon/adult-snapgraph.pl

# T C B
$SNAPGRAPH --minutes 1440 --output $IMGDIR/adult-tcb.24h.png --thumbnail T C B &
$SNAPGRAPH --minutes 180 --output $IMGDIR/adult-tcb.3h.png --thumbnail T C B &
$SNAPGRAPH --minutes 60 --output $IMGDIR/adult-tcb.1h.png --thumbnail T C B ;
