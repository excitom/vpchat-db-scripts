{
####TITLE Account renewed using credit balance, no payment required
...
Your VPchat account renewed today (account ID $aid). We applied your credit to the \$$amt balance. Your account is paid in full at this time.
