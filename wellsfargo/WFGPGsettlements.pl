#!/usr/bin/perl
#
# Periodically process settlements for the Wells Fargo Global Payment Gateway
#
# Tom Lang 11/2003
#
#use Date::Manip;
...
sub doSettlement {
	...
	&writeLog($accountID{$sid}, "WFGPG order ID: $sid - $orderID{$sid} processed");
...
$logFile  = $logDir . "/WFGPGprocess.log";
